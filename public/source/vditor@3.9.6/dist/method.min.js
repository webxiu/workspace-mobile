                  ...
                  n.forEach(function (e) {
                    e.parentElement.classList.contains("vditor-wysiwyg__pre") ||
                      ...
                      ("true" !== e.getAttribute("data-processed") &&
                        (ABCJS.renderAbc(e, a.abcRenderAdapter.getCode(e).trim()), (e.style.overflowX = "auto"), e.setAttribute("data-processed", "true")));
                  });
                });
            };
        },
            ...
            a = function (e) {
              e.querySelectorAll("pre > code").forEach(function (t, n) {
                ...
                if (
                  ...
                  var l = '<svg><use xlink:href="#vditor-icon-copy"></use></svg>';
                  ...
                  (m.className = "vditor-copy"),
                    (m.innerHTML =
                      ...
                      ((null === (s = window.VditorI18n) || void 0 === s ? void 0 : s.copied) || "已复制") +
                      "')\">" +
                      l +
                      "</span>");
                  var u = document.createElement("textarea");
                  (u.value = (0, r.X)(c)),
                    m.insertAdjacentElement("afterbegin", u),
                    t.before(m),
        ...
        702: (e, t, n) => {
          ...
          var r = n(54),
            ...
            o = function (e, t, n) {
              ...
              (s && s.href !== c && s.remove(), (0, a.c)(n + "/dist/js/highlight.js/styles/" + o + ".css", "vditorHljsStyle"), !1 !== e.enable) &&
              ...
              var c = e.firstChild,
                ...
                l = (function (e, t) {
                  ...
                  var i = e.getAssets(r),
                    ...
                    s = i.scripts,
                    c = window.markmap;
                  return a && c.loadCSS(a), s && c.loadJS(s), n;
                })(s, t),
                m = l.root,
                u = l.frontmatter,
                p = a(null == u ? void 0 : u.markmap);
              d.setData(m, p), d.fit();
            },
            c = function (e, t, n) {
              void 0 === t && (t = r.g.CDN);
        ...
        466: (e, t, n) => {
          ...
          var r = n(54),
            ...
            c = function (e, t) {
              ...
              if (0 !== n.length) {
                var c = { cdn: r.g.CDN, math: { engine: "KaTeX", inlineDigit: !1, macros: {} } };
                if ((t && t.math && (t.math = Object.assign({}, c.math, t.math)), "KaTeX" === (t = Object.assign({}, c, t)).math.engine))
                  (0, a.c)(t.cdn + "/dist/js/katex/katex.min.css", "vditorKatexStyle"),
                      ...
                      (0, i.G)(t.cdn + "/dist/js/katex/mhchem.min.js", "vditorKatexChemScript").then(function () {
                        n.forEach(function (e) {
                          if (
                            ...
                            var t = (0, o.X)(s.mathRenderAdapter.getCode(e));
              ...
              if (
                (Array.from(e.children).forEach(function (e, t) {
                  if ((0, r.W)(e)) {
                    ...
                    o.push(e.id), (a += e.outerHTML.replace("<wbr>", ""));
                  }
                }),
                "" === a)
              )
                ...
                n.lute.SetToC(!0),
                  "wysiwyg" !== n.currentMode || n.preview.element.contains(e)
                    ? "ir" !== n.currentMode || n.preview.element.contains(e)
                      ? (s.innerHTML = n.lute.HTML2VditorDOM("<p>[ToC]</p>" + a))
                      : (s.innerHTML = n.lute.SpinVditorIRDOM("<p>[ToC]</p>" + a))
                    : (s.innerHTML = n.lute.SpinVditorDOM("<p>[ToC]</p>" + a)),
                  n.lute.SetToC(n.options.preview.markdown.toc);
              else {
                t.classList.add("vditor-outline");
                var c = Lute.New();
                c.SetToC(!0), (s.innerHTML = c.HTML2VditorDOM("<p>[ToC]</p>" + a));
              }
                        ...
                        if (i.getAttribute("data-target-id")) {
                          ...
                          if (n)
                            if ("auto" === n.options.height) {
                              ...
                              n.options.toolbarConfig.pin || (o += n.toolbar.element.offsetHeight), window.scrollTo(window.scrollX, o);
                            } else
                          ...
                          else window.scrollTo(window.scrollX, a.offsetTop);
                          break;
                        }
                        i = i.parentElement;
                      }
            ...
            o.addEventListener("click", function () {
              ...
              (t / 90) % 2 == 1 && e.naturalWidth > i.parentElement.clientHeight
                ? (i.style.transform =
                    ...
                    t +
                    "deg)")
                : (i.style.transform = a + " rotateZ(" + t + "deg)"),
        ...
        312: (e, t, n) => {
          ...
          var r = n(54),
            ...
            a = function (e, t) {
              ...
              n ? n.href !== a && (n.remove(), (0, i.c)(a, "vditorHljsStyle")) : (0, i.c)(a, "vditorHljsStyle");
            };
        },
        227: (e, t, n) => {
          n.d(t, { Z: () => i });
    ...
    return (
      (() => {
        ...
        var e = n(478),
              ...
              return function (s) {
                return (function (a) {
                  ...
                  for (; o; )
                    try {
                      if (
                        ((n = 1), r && (i = 2 & a[0] ? r.return : a[0] ? r.throw || ((i = r.return) && i.call(r), 0) : r.next) && !(i = i.call(r, a[1])).done)
                      )
                        return i;
          ...
          x = function (e, t) {
            var n = j(t);
            return (0, y.G)(n.cdn + "/dist/js/lute/lute.min.js", "vditorLuteScript").then(function () {
              var r = (0, E.X)({
          ...
          _ = function (t, n, r) {
            return k(void 0, void 0, void 0, function () {
              ...
              return A(this, function (E) {
                switch (E.label) {
                  case 0:
                    return (g = j(r)), [4, x(n, g)];
                  case 1:
                    if (((f = E.sent()), g.transform && (f = g.transform(f)), (t.innerHTML = f), t.classList.add("vditor-reset"), g.i18n)) return [3, 5];
                    if (["en_US", "fr_FR", "pt_BR", "ja_JP", "ko_KR", "ru_RU", "sv_SE", "zh_CN", "zh_TW"].includes(g.lang)) return [3, 2];
                    throw new Error("options.lang error, see https://ld246.com/article/1549638745630#options");
                  case 2:
                    return (
                      (S = "vditorI18nScript" + g.lang),
                      document.querySelectorAll('head script[id^="vditorI18nScript"]').forEach(function (e) {
                        e.id !== S && document.head.removeChild(e);
                      }),
                      [4, (0, y.G)(g.cdn + "/dist/js/i18n/" + g.lang + ".js", S)]
                    );
                  case 3:
                    E.sent(), (E.label = 4);
                  case 4:
                    return [3, 6];
                  case 5:
                    (window.VditorI18n = g.i18n), (E.label = 6);
                  case 6:
                    return g.icon ? [4, (0, y.G)(g.cdn + "/dist/js/icons/" + g.icon + ".js", "vditorIconScript")] : [3, 8];
                  case 7:
                    E.sent(), (E.label = 8);
                  case 8:
                    return (
                      (0, w.Z)(g.theme.current, g.theme.path),
                      1 === g.anchor && t.classList.add("vditor-reset--anchor"),
                      (0, a.O)(t),
                      (0, c.s)(g.hljs, t, g.cdn),
                      (0, l.H)(t, { cdn: g.cdn, math: g.math }),
                      (0, u.i)(t, g.cdn, g.mode),
                      (0, p.K)(t, g.cdn, g.mode),
                      (0, o.P)(t, g.cdn),
                      (0, s.v)(t, g.cdn),
                      (0, i.p)(t, g.cdn, g.mode),
                      (0, h.P)(t, g.cdn, g.mode),
                      (0, v.B)(t, g.cdn),
                      (0, e.Q)(t, g.cdn),
                      (0, m.Y)(t),
                      g.speech.enable && T(t),
