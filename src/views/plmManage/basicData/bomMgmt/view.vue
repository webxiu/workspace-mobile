<template>
  <div class="detail">
    <div class="btns">
      ...
      <el-button size="small" type="primary" @click="submit" v-if="route.query.type !== 'view' && detailInfo.billState !== 2">保存</el-button>
      ...
      <el-button size="small" plain type="danger" @click="backAction" v-if="route.query.type === 'view'">回退</el-button>
      <!-- v-if="detailInfo.billState == 2 && detailInfo.disableStatus !== 1" 下推 -->
      <el-button size="small" type="success" @click="pushAction">下推</el-button>
...
defineOptions({ name: "BOMMgmtView" });
